...
function SkillCardMobile({
  ...
  return (
    <div className="flex overflow-clip flex-row items-center justify-between py-2 flex-1 h-full px-4.5 bg-[#141518] border border-solid border-[#1D2129]">
      <div className="flex overflow-clip flex-col items-start">
        <div className="w-fit font-['IBMPlexSerif-Regular','IBM_Plex_Serif',system-ui,sans-serif] text-white text-sm/4.5">
          {name}
        </div>
...
export default function Skills() {
  return (
    ...
    >
      ...
      <div className="sm:hidden flex flex-col w-full px-4">
        {" "}
        <SkillCardMobile
          name="C++"
      ...
      <div className="hidden sm:flex overflow-clip items-start self-stretch">
        <div className="overflow-clip h-15 w-0 md:w-13.75 shrink-0 bg-[#121415] border-r border-dashed border-r-[#1C2129]" />
        <div className="overflow-clip h-15 w-4 md:w-27.5 shrink-0 bg-[#141518] border-r border-r-solid border-r-[#1C2129]" />
        ...
        <div className="overflow-clip h-15 w-4 md:w-27.5 shrink-0 bg-[#141518] border-r border-dashed border-r-[#1C2129]" />
        <div className="overflow-clip h-15 w-0 md:w-13.75 shrink-0 bg-[#121415] border-r border-r-solid border-r-[#1C2129]" />
      </div>
      <div className="hidden sm:flex overflow-clip items-start self-stretch">
        <div className="overflow-clip h-15 w-0 md:w-13.75 shrink-0 bg-[#121415] border-r border-dashed border-r-[#1C2129]" />
        <div className="overflow-clip h-15 w-4 md:w-27.5 shrink-0 bg-[#141518] border-r border-r-solid border-r-[#1C2129]" />
