...
export default function Footer() {
  return (
    <div className="flex overflow-clip flex-col items-start gap-0 w-full bg-[#184ADC] p-0">
      <div className="flex overflow-clip self-stretch h-82.5 shrink-0">
        <div className="relative w-0 md:w-13.75 self-stretch shrink-0 bg-[#184ADC] border-r border-r-dashed z-9999 border-r-[#4165E1]">
          <Marker className={"-top-1 -left-1"} />
          <Marker className={"-top-1 -right-1"} />
        </div>
        <div className="relative z-9999 w-4 md:w-27.5 self-stretch shrink-0 bg-[#184ADC] border-r border-r-solid border-r-[#4165E1]">
          <Marker className={"-top-1 -left-1"} />
          <Marker className={"-top-1 -right-1"} />
        </div>
    ...
    "
          ...
          <div className="absolute bottom-0 w-full flex flex-col">
            ...
            <div className="opacity-10 [font-synthesis:none] flex overflow-clip flex-col items-center justify-end flex-1 border-r border-r-solid border-r-[#4165E1] antialiased">
              <div className="w-fit font-['IBMPlexSerif-Regular','IBM_Plex_Serif',system-ui,sans-serif] [-webkit-text-stroke:1px_#FFFFFF] [paint-order:stroke] text-transparent text-7xl md:text-[280px]/66">
                MRIDUL
              </div>
            </div>
            <div className="h-1 w-full border-t border-t-[#ffffff] opacity-10"></div>
        ...
        <div className="relative z-9999 w-4 md:w-27.5 self-stretch shrink-0 bg-[#184ADC] border-r border-r-dashed border-r-[#4165E1]">
          <Marker className={"-top-1 -left-1"} />
          <Marker className={"-top-1 -right-1"} />
        </div>
        <div className="relative z-9999 w-0 md:w-13.75 self-stretch shrink-0 bg-[#184ADC]">
          <Marker className={"-top-1 -left-1"} />
          <Marker className={"-top-1 -right-1"} />
        </div>
      </div>
