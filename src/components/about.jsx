  ...
  return (
    <div className="font-['iAWriterQuattroS-Regular','iA_Writer_Quattro_S',system-ui,sans-serif] flex overflow-clip flex-col items-start gap-0 w-full bg-[#141518] antialiased p-0">
      <div className="flex overflow-clip items-start self-stretch">
        ...
        <div className="overflow-clip w-27.5 self-stretch shrink-0 bg-[#141518] border-r border-r-solid border-r-[#1C2129]" />
        <div className="flex overflow-clip flex-col items-start flex-1 gap-1.25 justify-center border-r border-r-solid border-r-[#1C2129] p-6">
          <div className="w-fit font-['iAWriterQuattroS-Regular','iA_Writer_Quattro_S',system-ui,sans-serif] text-[#A2A5AD] text-sm/4.5">
            Part developer, part designer, part professional “just one more
            small tweak” person. Love doing competive programming.
          </div>
          <div className="w-fit font-['iAWriterQuattroS-Regular',system-ui,sans-serif] text-[#A2A5AD] text-sm/4.5">
        ...
        <div className="overflow-clip w-27.5 self-stretch shrink-0 h-0 bg-[#141518] border-r border-r-dashed border-r-[#1C2129]" />
