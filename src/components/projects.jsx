  ...
  return (
    ...
    >
      ...
      <div className="flex overflow-clip items-start self-stretch">
        <div className="overflow-clip w-13.75 self-stretch shrink-0 bg-[#121415] border-b border-b-solid border-b-[#1C2129] border-r border-r-solid border-r-[#1C2129]" />
        <div className="overflow-clip w-27.5 self-stretch shrink-0 border-b border-b-solid border-b-[#1C2129] border-r border-r-solid border-r-[#1C2129]" />
        <div className="flex overflow-clip items-center justify-center flex-1 border-b border-b-solid border-b-[#1C2129] border-r border-r-solid border-r-[#1C2129]">
          <div className="flex overflow-clip flex-col items-start gap-5 px-4.5 py-4.5 flex-1 border-r border-r-solid border-r-[#1D2129]">
            <div className="relative group overflow-clip h-62.5 self-stretch shrink-0 border border-dashed border-[#1C2129] hover:border-[#415b77]">
              ...
              />
              <div className="absolute inset-x-0 bottom-0 h-8 bg-[#090909]/90 border-t border-[#1C2129] translate-y-full group-hover:translate-y-0 transition-transform duration-300 flex items-center divide-x divide-[#1C2129]">
                <div
                  onClick={() => window.open("https://portalchat.vercel.app", "_blank")}
                ...
                <div
                  onClick={() => window.open("https://github.com/vmridul/portal", "_blank")}
                  className="flex-1 flex items-center justify-center gap-2 hover:bg-[#141518] cursor-pointer h-full transition-colors"
                >
            ...
            <div className="flex flex-col items-start gap-2.5 self-stretch">
              <div className="flex flex-col items-start">
                ...
                <div className="w-fit whitespace-pre font-['iAWriterQuattroS-Regular','iA_Writer_Quattro_S',system-ui,sans-serif] text-[#A2A5AD] text-sm/4.5">
                  Realtime Conversation Platform with group/personal
                  <br />
                  chats and voice/video calls with screen sharing.
                </div>
              </div>
              <div className="flex overflow-clip items-center gap-2.5">
          ...
          <div className="flex overflow-clip flex-col items-start px-4.5 py-4.5 self-stretch flex-1 gap-5">
            <div className="relative group overflow-clip self-stretch h-62.5 shrink-0 border border-dashed border-[#1C2129] hover:border-[#415b77]">
              ...
              <div className="absolute inset-x-0 bottom-0 h-8 bg-[#090909]/90 border-t border-[#1C2129] translate-y-full group-hover:translate-y-0 transition-transform duration-300 flex items-center divide-x divide-[#1C2129]">
                <div
                  onClick={() => window.open("https://wanderly-tripplanner.vercel.app/", "_blank")}
                  className="flex-1 flex items-center justify-center gap-2 hover:bg-[#141518] cursor-pointer h-full transition-colors"
                >
                  <Link01Icon size={14} color="white" />
                  <span className="text-white text-xs font-['iAWriterQuattroS-Regular','iA_Writer_Quattro_S',system-ui,sans-serif]">
                ...
                <div
                  onClick={() => window.open("https://github.com/vmridul/wanderly", "_blank")}
                  className="flex-1 flex items-center justify-center gap-2 hover:bg-[#141518] cursor-pointer h-full transition-colors"
                >
                  <GithubIcon size={14} color="white" />
                  <span className="text-white text-xs font-['iAWriterQuattroS-Regular','iA_Writer_Quattro_S',system-ui,sans-serif]">
